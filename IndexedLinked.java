 ...
 */
public class IndexedLinked implements AutoCompleter {
    private LinkedList<String> contents = new LinkedList<>();
    private LinkedList<String> contentsCopy = new LinkedList<>();
    ...
    public String strategyDescription(){
        return "Creates a LinkedList and goes through the list by " +
                "indexing through";
    }
    ...
    public List<String> allThatBeginWith(String prefix) throws IllegalStateException {
        ...
        if(!initialized){
            ...
            for (int i = contentsCopy.size() - 1; i > -1; i--) {
                String line = contentsCopy.get(i);
                if (prefix.length() > line.length()) {
                    contentsCopy.remove(i);
